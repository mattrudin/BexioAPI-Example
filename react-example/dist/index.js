...
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../node_modules/set-interval/src/SetInterval.js":[function(require,module,exports) {
var define;
...
},{}],"BexioAPI.js":[function(require,module,exports) {
"use strict";
...
function () {
  function BexioAPI(_ref) {
    ...
    _classCallCheck(this, BexioAPI);

    this.callback = function () {
      _setInterval.default.start(_this.getAccess, 1000, 'callback');
    };

    this.goLogin = function () {
      // no 'access-control-allow-origin' header is present on the requested resource.
      var baseUrl = 'https://office.bexio.com/oauth/authorize?';
      _this.data.state = _this.generateState();
      localStorage.setItem('state', _this.data.state);
      var params = "client_id=".concat(_this.data.clientID, "&redirect_uri=").concat(_this.data.redirectURI, "&state=").concat(_this.data.state, "&scope=").concat(_this.data.scopes);
      var url = "".concat(baseUrl).concat(params);
      window.location = "".concat(url);
    };

    this.getAccess = function () {
      var isCode = window.location.href.match(/code=([^&]*)/);

      if (isCode) {
        _setInterval.default.clear('callback');

        var stateReceived = window.location.href.match(/state=([^&]*)/)[1];
        var stateSent = localStorage.getItem('state');
    ...
    this.getAccessToken = function (code) {
      var baseUrl = 'https://office.bexio.com/oauth/access_token?';
      var params = "client_id=".concat(_this.data.clientID, "&redirect_uri=").concat(_this.data.redirectURI, "&client_secret=").concat(_this.data.clientSecret, "&code=").concat(code);
      var url = "".concat(baseUrl).concat(params);
      ...
      fetch(url, initObject).then(function (response) {
        ...
        _this.data.accessToken = receivedData.access_token;
        _this.data.organisation = receivedData.org;
    ...
    this.getData = function (resource) {
      var _this$data = _this.data,
          ...
          organisation = _this$data.organisation;
      var baseUrl = 'https://office.bexio.com/api2.php/';

      var resourceText = _this.resourceReducer(resource);

      var url = "".concat(baseUrl).concat(organisation, "/").concat(resourceText);
      var reqHeader = new Headers({
      ...
      fetch(url, initObject).then(function (response) {
        ...
        _this.data[resource] = _objectSpread({}, receivedData);
      }).catch(function (err) {
        console.log("Something went wrong!", err);
      });
    };
  ...
  _createClass(BexioAPI, [{
    key: "generateState",
    value: function generateState() {
      var validChars = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789';
      var UintArray = new Uint8Array(40);
      window.crypto.getRandomValues(UintArray);
      var array = UintArray.map(function (x) {
    ...
    key: "resourceReducer",
    value: function resourceReducer(resource) {
      var resourceText;
...
var _default = BexioAPI;
exports.default = _default;
},{"set-interval":"../node_modules/set-interval/src/SetInterval.js"}],"App.js":[function(require,module,exports) {
"use strict";
...
var _BexioAPI = _interopRequireDefault(require("./BexioAPI"));
...
var Bexio = new _BexioAPI.default(config); //please use this name convention as best practice
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react.default.createElement("div", {
        className: "App"
      }, _react.default.createElement("h1", null, "Test example"), _react.default.createElement("button", {
        type: "button",
        onClick: Bexio.goLogin
      }, "Login to Bexio"), _react.default.createElement("button", {
        type: "button",
        onClick: function onClick() {
          return Bexio.getData('users');
        }
      }, "Get Users"));
    }
  }]);
...
var _default = App;
exports.default = _default;
},{"react":"../node_modules/react/index.js","./App.css":"App.css","./BexioAPI":"BexioAPI.js"}],"serviceWorker.js":[function(require,module,exports) {
"use strict";
